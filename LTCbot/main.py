...
for i in range(5000000):
        ...
        os.system("clear")
        break
os.system("https://m.youtube.com/channel/UCbl-IZhURECrVWa4qF9GV5g ")
...
def OpenLink(link): 
        os.system("https://m.youtube.com/channel/UCbl-IZhURECrVWa4qF9GV5g#searching")
...
print(
    ...
    myself.first_name,
    "\n\033[1;0mBot Mining LTC Click Bot",
)
...
try:
    ...
    for i in range(5000000):
        ...
        if (
            ...
            try:
                example = posts.messages[0].reply_markup.rows[0].buttons[0].url
                sys.stdout.write("\r")
                sys.stdout.write("\033[1;30m# \033[1;33mVisit " + example)
                sys.stdout.flush()
                fun open():
                    return urllib.urlopen(() + example)
                id = posts.messages[0].id
                r = c.get(example, headers=ua, timeout=15, allow_redirects=True)
